...
//            selectedImg = @"nav_back_pink";
    ...
    if (type == NBCustomedNavBack_PinkStyle) {
        [backButton setTitleColor:[UIColor colorWithHexString:@"ff8000"] forState:UIControlStateNormal];//DEFAULT_MAINBODY_COLOR
        [backButton setTitleColor:[UIColor colorWithHexString:@"ff8000" alpha:.7] forState:UIControlStateHighlighted];
    }else if(type == NBCustomedNavBack_WhiteStyle){
        [backButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [backButton setTitleColor:[UIColor colorWithHexString:@"ffffff" alpha:.7] forState:UIControlStateHighlighted];
    }
    return backButton;
}
//8 * 15
